...
@Import(org.cham.springkafkatemplatesample.KafkaTestContainersLiveTest.KafkaTestContainersConfiguration.class)
@SpringBootTest(classes = SpringKafkaTemplateSampleApplication.class)
@DirtiesContext
